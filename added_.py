...
def query():
    ...
    tag_name = data.get('tag_name', '')  # Assuming 'tag_name' is provided in the JSON data
    response = result.get('answer', '')  # Assuming the answer is available in the 'answer' field of the result
